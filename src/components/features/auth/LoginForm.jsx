...
const LoginForm = () => {
  ...
  return (
    <div className={`${themeClasses.cardGlass} rounded-3xl hover:scale-[1.01] hover:shadow-2xl transition-all duration-500 w-full max-w-lg relative`}>
      ...
      <div className="p-12">
        <div className="text-center mb-12">
          <div className={`w-24 h-24 bg-gradient-to-br ${isDarkMode ? 'from-slate-300 to-gray-500' : 'from-slate-600 to-gray-800'} rounded-3xl mx-auto mb-8 flex items-center justify-center shadow-2xl transform hover:rotate-6 transition-all duration-500`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center pt-4">
            <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} font-light`}>Don't have an account? </span>
            <button type="button" className={`${isDarkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'} font-medium hover:underline transition-all duration-300`}>
              Create one
            </button>
          </div>
        </form>
