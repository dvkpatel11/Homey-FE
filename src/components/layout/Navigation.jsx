...
import { Home, CheckSquare, DollarSign, MessageSquare } from 'lucide-react';
...
const Navigation = ({ currentPage, setCurrentPage }) => {
  ...
  const tabs = [
    { id: 'home', icon: Home, label: 'Home', color: isDarkMode ? 'from-slate-500 to-gray-600' : 'from-slate-600 to-gray-700' },
